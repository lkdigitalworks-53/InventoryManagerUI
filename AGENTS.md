...
| Bulk-import chunking (>200 rows split into `Gateway.maxBatchSize`-sized batches, permanent-failure rollback + notify) | ✅ Done — pending real `qmltestrunner`/emulator run, see Skill 52 |
