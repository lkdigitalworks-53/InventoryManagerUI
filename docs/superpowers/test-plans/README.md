...
| 2026-09-02 | [`2026-09-02-batch-cleanup-on-delete-test-plan.md`](2026-09-02-batch-cleanup-on-delete-test-plan.md) | `docs/2026-09-02-batch-cleanup-on-delete-design` | Automated + on-device. Cascade-delete of stock batches (+ photo) on product delete, Tier C of three candidate designs compared and pushed as throwaway branches (deleted after the decision). On-device review the same day found a real regression this fix introduced (order reopen/reversal resurrecting a phantom batch) — fixed in a follow-up commit, see section 5 of the plan. 12 new unit tests across two files plus 2 earlier test files' continued passing as the regression check for a shared-helper refactor. |
