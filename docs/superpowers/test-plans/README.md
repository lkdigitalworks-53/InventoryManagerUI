...
|---|---|---|---|
| 2026-08-22 | [`2026-08-22-pr_taher_bug_fixes-test-plan.md`](2026-08-22-pr_taher_bug_fixes-test-plan.md) | `pr_taher_bug_fixes` | Automated. 31 new cases genuinely run this session (scratch-copy Qt-version workaround, see `SKILLS.md` Skill 46) + a static-trace gap list (UI pages, `XlsxService.cpp` — no C++ harness exists in this repo) + a short on-device checklist for the highest-risk gaps. |
