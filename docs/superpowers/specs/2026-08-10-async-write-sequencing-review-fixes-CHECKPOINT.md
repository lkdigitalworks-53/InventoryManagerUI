...
**Archived as part of rebasing `docs/e2e-testing-strategy-design` onto this branch** (Taher's
request, 2026-08-11) — this was the root `CHECKPOINT.md` content at the point of rebase, moved
here rather than lost, following the project's standing "archive the stale checkpoint" convention.
The branch continued past this point (`3142136` and others) — see `git log` for the rest; this
file captures only the checkpoint state as of the commit that conflicted during the rebase.
