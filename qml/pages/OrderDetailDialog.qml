                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Text { width: parent.width * 0.26; text: "Product"; color: "#c17817"; font.pixelSize: 12; font.bold: true; verticalAlignment: Text.AlignVCenter; height: parent.height }
                            Text { width: parent.width * 0.14; text: "SKU"; color: "#c17817"; font.pixelSize: 12; font.bold: true; verticalAlignment: Text.AlignVCenter; height: parent.height }
                            Text { width: parent.width * 0.14; text: "Price"; color: "#c17817"; font.pixelSize: 12; font.bold: true; verticalAlignment: Text.AlignVCenter; height: parent.height }
                            Text { width: parent.width * 0.14; text: "Quantity"; color: "#c17817"; font.pixelSize: 12; font.bold: true; verticalAlignment: Text.AlignVCenter; height: parent.height }
                            Text { width: parent.width * 0.18; text: "Total"; color: "#c17817"; font.pixelSize: 12; font.bold: true; verticalAlignment: Text.AlignVCenter; height: parent.height }
                    ...
                    Column {
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                Row {
                                    anchors { fill: parent; leftMargin: 12; rightMargin: 12 }
                                    Text { width: parent.width * 0.26; text: model.name; color: "#111827"; font.pixelSize: 12; verticalAlignment: Text.AlignVCenter; height: parent.height; elide: Text.ElideRight }
                                    Text {
                                        width: parent.width * 0.14
                                        text: {
                                            // Prefer productId (stable) over name lookup, which can collide
                                            // when two products share a name or one was renamed.
                                            var inv = null
                                            if (model.productId)
                                                inv = InventoryStore.getById(model.productId)
                                            if (!inv && model.name)
                                                inv = InventoryStore.findByName(model.name)
                                            return inv && inv.sku ? inv.sku : "—"
                                        }
                                        color: "#6b7280"; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; height: parent.height; elide: Text.ElideRight
                                    }
                                    Text { width: parent.width * 0.14; text: OrdersStore.formatCurrency(model.price); color: "#111827"; font.pixelSize: 12; verticalAlignment: Text.AlignVCenter; height: parent.height }
                                    Item {
                                    ...
                                    Text { width: parent.width * 0.18; text: OrdersStore.formatCurrency(model.price * model.quantity); color: "#111827"; font.pixelSize: 12; verticalAlignment: Text.AlignVCenter; height: parent.height }
                                    Item {
                                        width: parent.width * 0.14; height: parent.height
                                        Button {
                                            anchors.verticalCenter: parent.verticalCenter
