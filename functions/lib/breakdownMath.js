...
// Node port of qml/helper/BreakdownMath.js. Logic is byte-identical to the QML
// version -- only the module boilerplate differs. See functions/lib/orderMath.js
// for the parity-testing note.
//
// Pure breakdown math for the Analysis page's Sold/Purchased/Revenue views.
// Everything needed is passed in -- unit-testable without any framework.
...
//   allocate: fn           // OrderMath.allocate -- only required for metric "revenue"/"tax"/"discount"
// }
...
function _revenue(o) {
    ...
    var out = {};
    var orders = o.orders || [];
    var alloc = o.allocate || OrderMath.allocate;
